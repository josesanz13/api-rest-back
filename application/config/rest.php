...
// if( $_SERVER['HTTP_HOST'] == CURRENT_PRODUCTION_DOMAIN_NET || 
//     $_SERVER['HTTP_HOST'] == CURRENT_STAGING_DOMAIN_NET || 
//     $_SERVER['HTTP_HOST'] == CURRENT_SERVECOSOFTWARE_DOMAIN_COM ||
//     $_SERVER['HTTP_HOST'] == CURRENT_QA_DOMAIN_NET ||
//     $_SERVER['HTTP_HOST'] == CURRENT_QASTAGING_DOMAIN_NET ||
//     $_SERVER['HTTP_HOST'] == CURRENT_SERVECOSOFTWARE_DOMAIN_COM ||
//     $_SERVER['HTTP_HOST'] == CURRENT_QASERVECOSOFTWARE_DOMAIN_NET) 
//   { $config['rest_database_group'] = 'live'; }
// elseif
//     ($_SERVER['HTTP_HOST'] == DEV_DEVELOPMENT_DOMAIN_NET ||
//      $_SERVER['HTTP_HOST'] == CURRENT_DEVELOPMENT_DOMAIN_NET ||
//      $_SERVER['HTTP_HOST'] == SERVECOSOFTWARE_DEVELOPMENT_DOMAIN_COM) 
//     { $config['rest_database_group'] = 'devs_dev_vpc'; }  
// elseif
//     ($_SERVER['HTTP_HOST'] == D1_DEVELOPMENT_DOMAIN_NET ||
//      $_SERVER['HTTP_HOST'] == DEV1_DEVELOPMENT_DOMAIN_NET) 
//     { $config['rest_database_group'] = 'd1_dev_vpc'; }    
// elseif
//     ($_SERVER['HTTP_HOST'] == D2_DEVELOPMENT_DOMAIN_NET ||
//      $_SERVER['HTTP_HOST'] == DEV2_DEVELOPMENT_DOMAIN_NET) 
//     { $config['rest_database_group'] = 'd2_dev_vpc'; }
// elseif
//     ($_SERVER['HTTP_HOST'] == D3_DEVELOPMENT_DOMAIN_NET ||
//      $_SERVER['HTTP_HOST'] == DEV3_DEVELOPMENT_DOMAIN_NET) 
//     { $config['rest_database_group'] = 'd3_dev_vpc'; }
// elseif
//     ($_SERVER['HTTP_HOST'] == D4_DEVELOPMENT_DOMAIN_NET ||
//      $_SERVER['HTTP_HOST'] == DEV4_DEVELOPMENT_DOMAIN_NET) 
//     { $config['rest_database_group'] = 'd4_dev_vpc'; }
// elseif
//     ($_SERVER['HTTP_HOST'] == D5_DEVELOPMENT_DOMAIN_NET ||
//      $_SERVER['HTTP_HOST'] == DEV5_DEVELOPMENT_DOMAIN_NET) 
//     { $config['rest_database_group'] = 'd5_dev_vpc'; }
// elseif
//     ($_SERVER['HTTP_HOST'] == D6_DEVELOPMENT_DOMAIN_NET ||
//      $_SERVER['HTTP_HOST'] == DEV6_DEVELOPMENT_DOMAIN_NET) 
//     { $config['rest_database_group'] = 'd6_dev_vpc'; }
// elseif
//     ($_SERVER['HTTP_HOST'] == D7_DEVELOPMENT_DOMAIN_NET ||
//      $_SERVER['HTTP_HOST'] == DEV7_DEVELOPMENT_DOMAIN_NET) 
//     { $config['rest_database_group'] = 'd7_dev_vpc'; }
// elseif
//     ($_SERVER['HTTP_HOST'] == D8_DEVELOPMENT_DOMAIN_NET ||
//      $_SERVER['HTTP_HOST'] == DEV8_DEVELOPMENT_DOMAIN_NET) 
//     { $config['rest_database_group'] = 'd8_dev_vpc'; }
// elseif
//     ($_SERVER['HTTP_HOST'] == D9_DEVELOPMENT_DOMAIN_NET ||
//      $_SERVER['HTTP_HOST'] == DEV9_DEVELOPMENT_DOMAIN_NET) 
//     { $config['rest_database_group'] = 'd9_dev_vpc'; }
// elseif
//     ($_SERVER['HTTP_HOST'] == D10_DEVELOPMENT_DOMAIN_NET ||
//      $_SERVER['HTTP_HOST'] == DEV10_DEVELOPMENT_DOMAIN_NET) 
//     { $config['rest_database_group'] = 'd10_dev_vpc'; }
// else { $config['rest_database_group'] = 'devs_dev_vpc'; }
